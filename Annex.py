...
class TextSpeech:
    ...
    def opentxt(self):
        ...
        try:
            file_path=filedialog.askopenfilename(initialdir =r"C:\Users\shubh\OneDrive\Pictures\Notes",title="Select file",filetypes=(('text file',"*.txt"),("All files", "*.*")))
...
class SettingWindow:
    ...
    def settingWindow(self,root):
        ...
        self.volume=ttk.Label(self.setting,text="Assistant's Volume: ",borderwidth=0,font=('"Times New Roman"')).place(x=3,y=17)
